...
export function AddVendorForm({ isOpen, onClose, onSuccess }: AddVendorFormProps) {
  ...
  const {
    ...
    defaultValues: {
      is_active: true,
      can_login: true,
      serviceable_days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
      start_time: '08:00',
      end_time: '18:00',
                ...
                {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map(day => (
                  <label key={day} className="flex items-center space-x-2 text-sm">
                    <input
                      type="checkbox"
                      value={day}
                      defaultChecked={['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].includes(day)}
          ...
          <div className="flex space-x-3 pt-4">
            ...
            >
              <div className="flex items-center justify-center space-x-2">
                ...
                <span>{isSubmitting ? 'Adding Vendor...' : 'Add Vendor'}</span>
              </div>
            </button>
          </div>
        </form>
