/*
  # Add vendor service hours and availability columns
  ...
  2. Default Values
    ...
    - Enable weekend availability by default
    - Use Asia/Qatar timezone as default
*/

-- Add serviceable days (working days)
DO $$
BEGIN
  IF NOT EXISTS (
