...
import { useParams, useNavigate } from '@/lib/nextRouterAdapter';
...
export default function DiscussionDetailClient({ initialDiscussion }: DiscussionDetailClientProps) {
  ...
  const { logCommentFlag, logDiscussionView } = useActivityLogger();

  // Use initialDiscussion as initial data for hydration
