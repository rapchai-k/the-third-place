...
describe('Communities API Integration Tests', () => {
  ...
  describe('POST /communities - Create Community (Admin Only)', () => {
    it('should create community successfully as admin', async () => {
    ...
    it('should validate required fields', async () => {
      vi.mocked(supabase.from).mockReturnValue({
        ...
        single: vi.fn().mockResolvedValue({
          data: null,
          error: { message: 'null value in column "name" violates not-null constraint', code: '23502' },
        }),
      } as any)
  ...
  describe('PATCH /communities/:id - Update Community (Admin Only)', () => {
    it('should update community successfully as admin', async () => {
      const updatedCommunity = { ...mockCommunity, name: 'Updated Community Name' }
      ...
      const updates = { name: 'Updated Community Name' }
    ...
    it('should enforce RLS for updates', async () => {
      vi.mocked(supabase.from).mockReturnValue({
        update: vi.fn().mockReturnThis(),
        eq: vi.fn().mockReturnThis(),
        select: vi.fn().mockReturnThis(),
  ...
  describe('DELETE /communities/:id - Delete Community (Admin Only)', () => {
